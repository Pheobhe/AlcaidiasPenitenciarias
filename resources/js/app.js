...
iconoMenu.addEventListener('click', (e) => {
    ...
    if(rutaActual == ('http://localhost:8000/assets/img/filter-left-custom.svg'))
    {
        e.target.setAttribute('src','http://localhost:8000/assets/img/x-white.svg');
    }
    else
    {
        e.target.setAttribute('src','http://localhost:8000/assets/img/filter-left-custom.svg');
    }
});


//-----------------------------------------------------------------------------------------------------------------
// INTERACCIONES DE LAS TABLAS
...
// FIN INTERACCIONES DE LAS TABLAS
//-----------------------------------------------------------------------------------------------------------------